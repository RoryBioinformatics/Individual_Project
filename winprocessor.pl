...
print "\nPlease set $infile intensity cutoff\n";
my $intensity = <STDIN>;
chomp $intensity;

# Asks for the minimum cutoff of the M/Z range
print "\nPlease set $infile minimum M/Z range\n";
my $minimum = <STDIN>;
chomp $minimum;

# Asks for the maximum cutoff of the M/Z range
print "\nPlease set $infile maximum M/Z range\n";
my $maximum = <STDIN>;
chomp $maximum;

# Asks for the minimum peak distance between two peaks that 
print "\nPlease set $infile minimum M/Z peak distance\n";
my $dist = <STDIN>;
chomp $dist;
